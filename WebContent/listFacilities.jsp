...
<h1><a	class="btn btn-secondary " href='${backSearchFacilityPage}'>Back</a></h1>
		<h1>
		...
		<h3><small class="offset-md-6"><strong>Select a Facility and click on View Facility Details to view more details!!</strong></small></h3>
		<div>
			<form action="/UTA_Mac_FMS/FacilityController?action=listSpecificFacility" method="POST">
			<div class="table-responsive">
				...
				<br> <input type="submit" class="btn btn-primary col-md-3 offset-md-3" id="submit" value="View Facility Details" disabled> <br> <br>
				</form>
</div>
</body>
</html>