...
<sql:setDataSource var="dsfacility" driver="com.mysql.jdbc.Driver"
	...
	<h1><a	class="btn btn-secondary " href='${backListPage}'>Back</a></h1>
		...
		<div>
			<form action="/UTA_Mac_FMS/MarController?action=requestMar" method="POST" name="mar_form">
				<div class="row">
					<div class="col">
			...
			<div class="row">
				...
				<br> 
				<input type="submit" class="btn btn-primary col-md-3" id="updatemar" role="button" value="Request Repair">
			</form>
		</div>
	</div>
</body>
