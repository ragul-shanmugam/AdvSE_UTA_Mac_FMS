...
<body onload='onPageLoad();'><br>
		<h1>
			List of problems reported <a class="btn btn-secondary offset-md-1 "
				href='${homePage}'>Home Page</a> <a
				class="btn btn-danger offset-md-1"
				href="/UTA_Mac_FMS/LogoutController">Logout</a>
		</h1>
		<h3><small class="offset-md-6"><strong>Select a Report and click on View Report Details to view more details!!</strong></small></h3>
		<div>
			<form action="/UTA_Mac_FMS/MarController?action=listSpecificMar" method="POST">
				<div class="table-responsive">
					<table class="table table-striped">
						<thead>
							<tr>
								<th scope="col" style="text-align: center">Select Report</th>
						...
						<tbody>
							<c:forEach items="${MARS}" var="mar" varStatus="status">
								<tr>
									<td style="text-align: center"><input onclick="document.getElementById('submit').disabled = false;"  type="radio" id="radioReport${status.count}" name="radioReport" value="${status.count}"></td>
				...
				<br> <input type="submit" class="btn btn-primary col-md-3 offset-md-3" id="submit" value="View Report Details" disabled> <br> <br>
			</form>
		</div>
</body>
</html>